...
CREATE TABLE `offer` (
  ...
  `wage` varchar(50) COLLATE utf8mb4_general_ci DEFAULT NULL,
  ...
  `link` varchar(1024) COLLATE utf8mb4_general_ci DEFAULT NULL,
...
/*!50003 SET sql_mode              = 'NO_AUTO_VALUE_ON_ZERO' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `UPDATE_PROFILE`(`p_fname` VARCHAR(50), `p_lname` VARCHAR(50), `p_id_roles` INT, `p_email` VARCHAR(255), `p_password` VARCHAR(255), `p_id_profile` INT, `p_name` VARCHAR(50))
BEGIN
	UPDATE profile
...
-- Dump completed on 2023-03-24 14:58:00
