...
<h1 class="sombre text-center">Ajouter une offre</h1>
	...
	<form action="" method="post">
		...
		<label for="title"><strong style="font-size: 130%;">Titre de l'offre</strong><input class="col rounded position-absolute end-0" style="width: 50%;"type="text" name="title" id="title" placeholder="Entrez le titre de l'offre"></label>
		...
		<label for="startdate" class="mt-4"> <strong style="font-size: 130%;">Date de début</strong> <input type="date" class="col rounded position-absolute end-0" style="width: 50%;"name="startdate" id="startdate"></label>
		<div class=" mt-4 "><label for="period"> <strong style="font-size: 130%;">Durée</strong><input type="text" class="col rounded position-absolute end-0" style="width: 50%;"name="period" id="period" placeholder="Ex : entre 35 jours et 4mois"></label></div>
		<div class=" mt-4 "><label for="email"> <strong style="font-size: 130%;">E-mail</strong><input type="email" class="col rounded position-absolute end-0" style="width: 50%;"name="email" id="email" placeholder="Entrez l'email de contact"></label></div>
		<div class=" mt-4 "><label for="tel"> <strong style="font-size: 130%;">Téléphone</strong><input type="tel" class="col rounded position-absolute end-0" style="width: 50%;"name="tel" id="tel" placeholder="Entrez le téléphone de contact"></label></div>
		<div class=" mt-4 "><label for="wage"> <strong style="font-size: 130%;">Gratification</strong><input type="text" class="col rounded position-absolute end-0" style="width: 50%;"name="wage" id="wage" placeholder="Ex : 750€ (Rapporter au mois)"></label></div>
		<div class=" mt-4 "><label for="amount"> <strong style="font-size: 130%;">Nombre de places</strong><input type="number" class="col rounded position-absolute end-0" style="width: 50%;"name="amount" id="amount" placeholder="Ex : 4"></label></div>
	...
	<textarea class="col rounded" style="width: 100%;"name="description" id="description" cols="3" rows="5" placeholder="Donnez plus de détails"></textarea></div>
		...
		<select name="activity" class="col rounded position-absolute end-0" style="width: 50%;" id="activity">
			<option value="0">-- Choisissez une option --</option>
