  ...
  <div class="row g-0 ">
    ...
    <div class="col-md-8">
      ...
      <?php
        ...
        <button class="rounded-4 but clair px-2 py-2" type="button" data-bs-toggle="collapse" data-bs-target="#Pilote1" aria-expanded="false" aria-controls="Pilote1" style="width:max-content;">
        <?= $CadreDrop?>
        </button>
        </div>
      </div>
