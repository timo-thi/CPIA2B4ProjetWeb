...
<div class="container mt-5 bg-clair rounded-3" style="width: 65vh; max-width=90%;height:max-content"><!--ou style="width: 40%; max-width=90vh;"-->
            <h1 class="sombre text-center">Modifier ou supprimer une offre</h1>
            <form action="" class="mx-auto" method="" style="width:95%">
                ...
                <div class="container mt-4 position-relative">
                    ...
                    <select name="" id="adresse" class="col border-1 rounded  position-absolute end-0" style="width: 40%;" >
                        <option value="1"><!--L'adresse actuel--></option>
                    </select>
                </div>
