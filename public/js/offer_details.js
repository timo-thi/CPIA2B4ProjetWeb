$(document).ready(function(){
    $('.list-item').click(function(){
        $.ajax({
            ...
            $('#of-postulate').attr('onclick', "window.location.href='../public/index.php?p=offer.postulate&id="+jdata.id_offer + "'");
            $('#of-edit').attr('onclick', 'window.location.href="../public/index.php?p=offer.edit&id='+jdata.id_offer + '"');
